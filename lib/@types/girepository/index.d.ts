...
export function callable_info_invoke(info: CallableInfo, _function: any | null, in_args: Argument[], out_args: Argument[], return_value: Argument, is_method: boolean, _throws: boolean): boolean;
...
export function cclosure_marshal_generic(closure: GObject.Closure, return_gvalue: any, n_param_values: number, param_values: any, invocation_hint?: any | null, marshal_data?: any | null): void;
...
export function object_info_find_method_using_interfaces(info: ObjectInfo, name: string): [FunctionInfo | null, ObjectInfo];
