...
export type DBusSignalCallback = (connection: DBusConnection, sender_name: string | null, object_path: string, interface_name: string, signal_name: string, parameters: GLib.Variant) => void;
...
export module OsxAppInfo {
    export interface ConstructorProperties extends GObject.Object.ConstructorProperties {
        [key: string]: any;
    }
}
export class OsxAppInfo extends GObject.Object implements AppInfo {
    static $gtype: GObject.GType<OsxAppInfo>;
    constructor(properties?: Partial<OsxAppInfo.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<OsxAppInfo.ConstructorProperties>, ...args: any[]): void;
    // Members
    get_filename(): string;
    // Implemented Members
